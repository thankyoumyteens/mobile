...
public class OrderItem {
    ...
    public OrderItem(Long id, Long userId, Long orderNo, Long productId, String productName, String productImage, String typeValues, BigDecimal currentUnitPrice, Integer quantity, BigDecimal totalPrice, Date createTime, Date updateTime, String typeNames) {
        this.id = id;
        this.userId = userId;
        this.orderNo = orderNo;
        this.productId = productId;
