...
public final class AlipayConfig {
    ...
    // 编码
    public static String CHARSET = PropertiesUtil.getProperty("alipay.charset", "UTF-8");
    // 返回格式
    public static String FORMAT = PropertiesUtil.getProperty("alipay.format", "json");
    // 支付宝公钥
    public static String ALIPAY_PUBLIC_KEY = PropertiesUtil.getProperty("alipay.alipayPublicKey", "");
    // 日志记录目录
    public static String log_path = "/log";
    // RSA2
    public static String SIGNTYPE = PropertiesUtil.getProperty("alipay.signtype", "RSA2");
}
